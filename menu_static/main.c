...
int main()
{
    char menu[5][20]= {"new","display","delete by id","delet by name","exit"};
    int i;
    int stop=0;
    int cursour=0;
    int flag=0;
    ...
    do
    {
        ...
        case 13:
            ...
            case 0:
                ...
                scanf("%d",&newindex);
                if(arr[newindex].id!=-1&&newindex<3&&newindex>=0)
                {
                ...
                else if(arr[newindex].id==-1&&newindex<3&&newindex>=0)
                {
                    add(arr,newindex);
                }
                else
